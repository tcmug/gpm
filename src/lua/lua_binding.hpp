...
#define LUA_BINDING(class_name) \
    static const char *className; \
    static const Luna <class_name>::FunctionType methods[]; \
    static const Luna <class_name>::PropertyType properties[]; \
    friend class Luna <class_name>;

#define LUA_BINDING_REGISTER(lua_state, class_name) \
    Luna <class_name>::Register(L);
